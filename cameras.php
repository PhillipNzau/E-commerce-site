...
<section>
    ...
    <div class="row">
        <h5 class="title center">Cameras</h5>
        <div class="divider"></div>
        <!--Lpatop fetcher-->     
...
<section>
    <div class="container banner3 animated bounceIn delay-1s pt20 pb20 row">
        <?php 
            $im = "SELECT * FROM product WHERE p_category='ACCESSORIES' ORDER BY RAND() LIMIT 1" ;
            if (!$im) {
            echo "sql error";
            }
            ...
            while($result = mysqli_fetch_assoc($records)){?>
                ...
                <div class="col s12 m6">
                    <h5 class="animated bounceIn delay-2s tech title"><?php echo $result['p_name']; ?></h5>
                    <div class="pl20 left animated bounceIn delay-1s tech title">Tech week</div>
